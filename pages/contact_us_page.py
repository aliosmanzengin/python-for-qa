...
class ContatcUsPage(BasePage):
    ...
    __terms_and_conditions_checkbox = (By.XPATH, "(//*[@name='check' and (ancestor::gd-checkbox[@formcontrolname='policy'])]) ")
    __contact_consent_checkbox = (By.XPATH, "(//*[@name='check' and (ancestor::gd-checkbox[@formcontrolname='allowContact'])])")
